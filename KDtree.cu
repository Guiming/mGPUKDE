...
void KDtree::SearchAtNodeKNN(KDNode* cur, const Point& query, int k, vector<int> &ret_index, vector<float> &ret_dist, KDNode** ret_node)
{
    vector <Point>& pts = *m_pts;
...
void KDtree::SearchAtNodeRangeKNN(KDNode* cur, const Point& query, int k, float& range, vector<int> &ret_index, vector<float> &ret_dist)
{
...
void KDtree::SearchKNN(const Point& query, int k, vector<int> &ret_index, vector<float> &ret_dist)
{
