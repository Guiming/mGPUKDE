...
public:
    ...
    void SearchKNN(const Point& query, int k, vector<int> &ret_index, vector<float> &ret_sq_dist); // nearest neighbor search
...
private:
    ...
    void SearchAtNodeKNN(KDNode* cur, const Point& query, int k, vector<int>& ret_index, vector<float>& ret_dist, KDNode** ret_node);
    void SearchAtNodeRangeKNN(KDNode* cur, const Point& query, int k, float& range, vector<int>& ret_index, vector<float>& ret_dist);
